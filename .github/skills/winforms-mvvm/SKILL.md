...
name: winforms-mvvm
description: >-
  Use for WinForms MVVM on .NET 8+: Commands and DataContext, MVVM Community
  Toolkit-generated ViewModels, event-handler migration, designer .datasource
  support, dependency injection and unit testing, cross-framework ViewModel
  sharing, ObservableCollection-to-BindingList adaptation, and troubleshooting
  generated properties or commands.
---
